...
interface ShinyButtonAsButtonProps extends ShinyButtonBaseProps {
  href?: undefined;
  onClick?: () => void;
  type?: "button" | "submit" | "reset";
}

interface ShinyButtonAsLinkProps extends ShinyButtonBaseProps {
  href: string;
  external?: boolean;
  onClick?: () => void;
}

type ShinyButtonProps = ShinyButtonAsButtonProps | ShinyButtonAsLinkProps;
...
export function ShinyButton({
  ...
  if ("href" in rest && rest.href) {
    const { href, external, onClick } = rest as ShinyButtonAsLinkProps;
    return (
      <>
        <style>{css}</style>
        {external ? (
  ...
  const { onClick, type = "button" } = rest as ShinyButtonAsButtonProps;
  return (
    <>
      <style>{css}</style>
      <button
