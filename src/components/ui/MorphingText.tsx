...
export function MorphingText({
  ...
  return (
    <span className={`morphing-text ${className ?? ""}`}>
      <span className="sr-only">{texts[0]}</span>
      <span ref={text1Ref} className="morphing-text-layer" aria-hidden="true" />
      <span ref={text2Ref} className="morphing-text-layer" aria-hidden="true" />
    </span>
  );
}
